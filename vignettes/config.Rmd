...
*   For best syntax hightlighting results, you must use classes:
    ...
    Substitute `pygments` for the [style of your choice][styles], and 
    copy the resulting code into the appropriate CSS file. Unfortunately,
    the correct location varies by theme, so you'll need to do a little 
    detective work to figure out the best place to put it.
