...
Get started by publishing the site once; that will enable you to figure out where the site will be published. Then update `baseUrl` in `config.toml` and republish.
